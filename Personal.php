...
<link rel="stylesheet"
	...
	function validate()
	{
		...
		document.form1.address2.style.background = "White";
		document.form1.suburb.style.background = "White";						        		        document.form1.state.style.background = "White";
		document.form1.pcode.style.background = "White";
		document.form1.country.style.background = "White";							        
		document.form1.email.style.background = "White";
		document.form1.mobile.style.background = "White";
		document.form1.business.style.background = "White";
		document.form1.work.style.background = "White";
		...
		if (document.form1.fname.value == "")
		{
			...
			document.form1.fname.style.background = "Pink";
         		error = false;
		}
		if (document.form1.lname.value == "")
		{
			...
			document.form1.lname.style.background = "Pink";
         		error = false;
		}
		if (document.form1.address1.value == "")
		{
			...
			document.form1.address1.style.background = "Pink";
         		error = false;
		}
		if (document.form1.suburb.value == "")
		{
			...
			document.form1.suburb.style.background = "Pink";
         		error = false;
		}
		if (document.form1.email.value == "")
		{
			...
			document.form1.email.style.background = "Pink";
         		error = false;
		}
		
		// in Australia
       if(document.form1.country.value == "Australia"){

		if (document.form1.state.value == "")
		{
         		error_type = 3;
			document.form1.state.focus();		
			document.form1.state.style.background = "Pink";
         		error = false;
		}
		   ...
		   if (document.form1.pcode.value == ""){
			...
			document.form1.pcode.style.background = "Pink";
         		error = false;	
		}
		...
		if ( document.form1.mobile.value != "" && phonefilter.test(document.form1.mobile.value) ==false)
		{
			error_type = 2;
			document.form1.mobile.focus();
			document.form1.mobile.style.background = "Pink";
         		error = false;
		}
	   if ( document.form1.business.value != "" && phonefilter.test(document.form1.business.value) ==false)
		{
			error_type = 2;
			document.form1.business.focus();
			document.form1.business.style.background = "Pink";
         		error = false;
		}	
		if ( document.form1.work.value != "" && phonefilter.test(document.form1.work.value) ==false)
		{
			error_type = 2;
			document.form1.work.focus();
			document.form1.work.style.background = "Pink";
         		error = false;
		}	
		...
		if ( error ==false)
		{
			switch (error_type)
			{
				...
				break;
				case 3: alert("If your country is Australia, please fill in state and postcode.");
				break;
...
<div>
	...
	<h3>Complete Booking – Stage 1 of 4 Screens</h3>
	<p><span style="color:#F00">* </span> indicates required fields</p>
	<p><span style="color:blue">* </span>State and Postcode are required fields for booking from Australia</p>
    vious details entered are presen
    <form name="form1" action="payment.php" method="POST" onsubmit="return validate()">
	<table width="90%" border="0">
		<tbody><tr>
			<td>Given name <span style="color:#F00">* </span></td>
		...
		<tr>
			<td>Address Line 1 <span style="color:#F00">* </span></td>
		...
		<tr>
			<td>State <span style="color:blue">* </span></td>
        ...
        <tr>
			<td>Post code <span style="color:blue">* </span></td>
...
<option value="Zimbabwe">Zimbabwe</option>
        ...
        <tr>
			<td>Business phone </td>
    			<td><input type="text" name="business" id="business" size="50"></td>
		</tr>
         <tr>
			<td>Work phone </td>
    			<td><input type="text" name="work" id="work" size="50"></td>
		</tr>
	</tbody></table>
<center>
